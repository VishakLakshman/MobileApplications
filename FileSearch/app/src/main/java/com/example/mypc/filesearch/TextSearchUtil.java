...
public class TextSearchUtil {
     ...
     * 
     */
    public static ArrayList<String> SearchKeyWordInFile(ArrayList<String> fileLine, String keyWord,int i) {
        ...
        if(matchcase == 0)
           wordSearch(fileLines, keyWord);
            ...
            wordSearchNoMatchCase(fileLines, keyWord.toLowerCase());
    ...
    private static void wordSearchNoMatchCase(ArrayList<String> fileLines, String keyWord){
        for(int i = 0; i < fileLines.size(); i++){
            String line = fileLines.get(i);
